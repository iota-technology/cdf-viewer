...
- LABL_PTR_* attribute lookup now searches for existing attributes instead of calculating which one to use
- Supports multiple label pointer formats (single variable reference, multiline values, comma-separated)
